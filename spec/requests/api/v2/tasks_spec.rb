...
RSpec.describe 'Task API' do
    ...
    describe 'GET /tasks' do
        ...
        context 'when filter params is sent' do
           let!(:notebook_task_1) { create(:task, title: 'Check if the notebook is broke', user_id: user.id) }
           let!(:notebook_task_2) { create(:task, title: 'By a new notebook', user_id: user.id) } 
